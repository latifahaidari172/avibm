...
export default function Home() {
  return (
    <main style={{ minHeight: '100vh' }}>
      ...
      {/* State Cards */}
      <section style={{ padding: '0 clamp(16px,4vw,40px) 80px', maxWidth: 900, margin: '0 auto' }}>
        <div className="section-label" style={{ textAlign: 'center', marginBottom: 32 }}>Select Your State</div>
        <div className='state-cards-grid' style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, gridAutoRows: '1fr' }}>
          {/* QLD */}
          <Link href="/register/qld" style={{ textDecoration: 'none', display: 'block', height: '100%' }}>
            ...
            >
              ...
              <h2 className='state-card-h2' style={{ fontSize: 36, color: 'var(--text)', marginBottom: 8 }}>QUEENSLAND</h2>
          ...
          <Link href="/register/sa" style={{ textDecoration: 'none', display: 'block', height: '100%' }}>
            ...
            >
              ...
              <h2 className='state-card-h2' style={{ fontSize: 36, color: 'var(--text)', marginBottom: 8 }}>SOUTH AUSTRALIA</h2>
              <p style={{ color: 'var(--text-muted)', fontSize: 14, lineHeight: 1.6, marginBottom: 20 }}>
        ...
        {/* Coming soon states */}
        <div className='coming-soon-grid' style={{ marginTop: 16, display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 8 }}>
          {['VIC', 'NSW', 'WA', 'NT'].map(s => (
            <div key={s} style={{
              background: 'var(--dark-2)',
              border: '1px solid var(--border)',
      ...
      <section style={{
        ...
        <div className='pricing-grid' style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12, maxWidth: 700, margin: '0 auto' }}>
          {[
